...
def perceptron_mse_mnist(learning_rate, pca=False):
    ...
    if pca:
        Hp = HelpP.HelpPlots()
        Hp.plotScatterAndDecisionBoundaryOfClassifier(sgdc, test_images, pred, "MNIST", 10, "Perceptron MSE",
...
def perceptron_mse_orl(learning_rate, pca=False):
    ...
    if pca:
        Hp = HelpP.HelpPlots()
        Hp.plotScatterAndDecisionBoundaryOfClassifier(sgdc, test_data, pred, "ORL", 40, "Perceptron MSE",
                                                      hyper=str(learning_rate))
